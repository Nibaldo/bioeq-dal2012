...
public class MedisearchPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Medisearch";
	...
	private MedisearchPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new MedisearchPersistentManager();
		}
